	...
	public class BlueWhaleGasGauge : GasGaugeInterface
    {
		...
		*/
		...
		struct config_data_t
		{
			...
			//byte debug;                                          // enable or disable debug information
		...
		private void bmu_init_chip()
        {
			...
			bmu_printk(string.Format("AAAA OZ8806 DRIVER VERSION is {0}", VERSION));
			...
			bmu_printk(string.Format("OZ8806 test parameter  {0:F2},{1:F2},{2:F2},{3:F2},{4:F2},{5:F2},{6:F2},{7:F2},{8:F2},{9:F2},{10:d},{11:d},",
			...
			bmu_printk(string.Format("OZ8806 test parameter  {0:F2},{1:F2},{2:F2},{3:F2},{4:F2},{5:F2},{6:F2},{7:F2},{8:F2},{9:F2},{10:F2},{11:F2},",
				(myProject.dbRsense * 1000),
                myProject.dbPullupR,
                myProject.dbPullupV,
                2.5F,//myProject.dbCARLSB,
        ...
        private void wait_ocv_flag_fun()
        {
			...
			//bmu_printk(string.Format("regeidter 0x00 is %x", i));

			//afe_register_read_byte(num_9, &i);
			//bmu_printk(string.Format("regeidter 0x09 is %x", i));	
