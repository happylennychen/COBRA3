...
namespace O2Micro.Cobra.Common
{
    public class LibErrorCode
    {
        ...
        #region Public statis member Definition
        public static UInt32 uVal01 = 0;
        public static UInt32 uVal02 = 0;
        public static UInt32 uVal03 = 0;
        public static float fVal01 = 0.0F;
        public static float fVal02 = 0.0F;
        public static float fVal03 = 0.0F;
        public static string strVal01 = "";
        public static string strVal02 = "";
        public static string strVal03 = "";

        public static Double PARAM_PHYSICAL_ERROR = -999999;
        #endregion
		...
		private const UInt32 IDS_ERR_SECTION_PROSCAN = 0x10031000;
		private const UInt32 IDS_ERR_SECTION_PROVOLTCAL = 0x10032000;
		private const UInt32 IDS_ERR_SECTION_PROCURRCAL = 0x10033000;
		private const UInt32 IDS_ERR_SECTION_PROTEMPCAL = 0x10034000;
		public const UInt32 IDS_ERR_PROSFL_XML_RELATIONS = IDS_ERR_SECTION_PRODUCTIONSFL + 0x10;
		public const UInt32 IDS_ERR_PROSFL_XML_SCAN_ADC = IDS_ERR_SECTION_PRODUCTIONSFL + 0x11;
		public const UInt32 IDS_ERR_PROSFL_XML_REGISTER = IDS_ERR_SECTION_PRODUCTIONSFL + 0x12;
		public const UInt32 IDS_ERR_PROSFL_DEM_ACCESS_FAIL = IDS_ERR_SECTION_PRODUCTIONSFL + 0x100;
		public const UInt32 IDS_ERR_PROSFL_DEM_WRITE_FAIL = IDS_ERR_SECTION_PRODUCTIONSFL + 0x101;
		public const UInt32 IDS_ERR_PROVOLT_VOLT_ADC_DATA = IDS_ERR_SECTION_PROVOLTCAL + 0x10;
		public const UInt32 IDS_ERR_PROVOLT_VOLT_2nd_OFFSET = IDS_ERR_SECTION_PROVOLTCAL + 0x11;
		public const UInt32 IDS_ERR_PROVOLT_VOLT_OFFSET_RANGE = IDS_ERR_SECTION_PROVOLTCAL + 0x12;
		public const UInt32 IDS_ERR_PROCOLT_VOLT_INPUT_EMPTY = IDS_ERR_SECTION_PROVOLTCAL + 0x13;
		public const UInt32 IDS_ERR_PROCURR_1POINT_ADC_DATA = IDS_ERR_SECTION_PROCURRCAL + 0x10;
		public const UInt32 IDS_ERR_PROCURR_2POINT_ADC_DATA = IDS_ERR_SECTION_PROCURRCAL + 0x11;
		public const UInt32 IDS_ERR_PROCURR_INPUT_SAME = IDS_ERR_SECTION_PROCURRCAL + 0x12;
		public const UInt32 IDS_ERR_PROCURR_INPUT_DIFF = IDS_ERR_SECTION_PROCURRCAL + 0x13;
		public const UInt32 IDS_ERR_PROCURR_INPUT_SIGNED = IDS_ERR_SECTION_PROCURRCAL + 0x14;
		public const UInt32 IDS_ERR_PROCURR_CURR_ADC_DATA = IDS_ERR_SECTION_PROCURRCAL + 0x15;
		public const UInt32 IDS_ERR_PROCURR_CURR_2nd_OFFSET = IDS_ERR_SECTION_PROCURRCAL + 0x16;
		public const UInt32 IDS_ERR_PROCURR_CURR_OFFSET_RANGE = IDS_ERR_SECTION_PROCURRCAL + 0x17;
		public const UInt32 IDS_ERR_PROTEMP_TEMP_ADC_DATA = IDS_ERR_SECTION_PROTEMPCAL + 0x10;
		public const UInt32 IDS_ERR_PROTEMP_TEMP_2nd_OFFSET = IDS_ERR_SECTION_PROTEMPCAL + 0x11;
		public const UInt32 IDS_ERR_PROTEMP_TABLE_PHYTOHEX = IDS_ERR_SECTION_PROTEMPCAL + 0x12;
		public const UInt32 IDS_ERR_PROTEMP_TEMP_OFFSET_RANGE = IDS_ERR_SECTION_PROTEMPCAL + 0x13;
		#endregion
        ...
        #region LPC812 flash access, IDS_ERR_SECTION_LPC812_FLASH = 0x10150000
        public const UInt32 IDS_ERR_ERASE_LPC812_MAIN_FLASH_TIMEOUT = 0x10150100;

        public const UInt32 IDS_ERR_WRITE_LPC812_MAIN_FLASH_CHECKSUM = 0x10150200;
        public const UInt32 IDS_ERR_READ_LPC812_MAIN_FLASH_CHECKSUM = 0x10150300;
        public const UInt32 IDS_ERR_INVALID_LPC812_MAIN_FLASH_DATA_ERROR = 0x10150400;
        public const UInt32 IDS_ERR_INVALID_MAIN_FLASH_COMPARE_ERROR = 0x10150500;

        public const UInt32 IDS_ERR_INVALID_LPC812_FILE = 0x10151000;
        public const UInt32 IDS_ERR_FILE_LPC812_DATA_CHECUSUM = 0x10151100;

        public const UInt32 IDS_ERR_MODE_ISP_FAIL = 0x10152000;
        #endregion

        #region Project File access, IDS_ERR_SECTION_PROJECT_FILE = 0x10160000
        public const UInt32 IDS_ERR_SECTION_PROJECT_FILE = 0x10160000;
        public const UInt32 IDS_ERR_SECTION_PROJECT_FILE_ZIP_ERROR = IDS_ERR_SECTION_PROJECT_FILE+0x01;
        public const UInt32 IDS_ERR_SECTION_PROJECT_FILE_UNZIP_ERROR = IDS_ERR_SECTION_PROJECT_FILE + 0x01;
        public const UInt32 IDS_ERR_SECTION_PROJECT_CONTENT_FILE_NOTEXIST = 0x10160100;
        public const UInt32 IDS_ERR_SECTION_PROJECT_CONTENT_FILE_FOTMAT_ERROR = 0x10160101;
        
        public const UInt32 IDS_ERR_SECTION_PROJECT_CONTENT_FILE_NOTEXIST_FIRMWARE = 0x10160200;
        public const UInt32 IDS_ERR_SECTION_PROJECT_CONTENT_FILE_FIRMWARE_FOTMAT_ERROR = 0x10160201;
        public const UInt32 IDS_ERR_SECTION_PROJECT_CONTENT_FILE_FIRMWARE_CHECKSUM_ERROR = 0x10160202;
        public const UInt32 IDS_ERR_SECTION_PROJECT_CONTENT_FILE_NOTEXIST_PARAMETER = 0x10160300;
        public const UInt32 IDS_ERR_SECTION_PROJECT_CONTENT_FILE_NOTEXIST_TABLE1 = 0x10160400;
        ...
        public static string GetErrorDescription(UInt32 dwErr, bool bSpecific = true)
        {
            ...
            switch (dwErr)
            {
                ...
                case IDS_ERR_INVALID_INFO_FLASH_DATA:
                    ...
                    break;
                case IDS_ERR_INVALID_MAIN_FLASH_COMPARE_ERROR:
                    strErr = "Flash compare error.";

                    break;             
        #endregion

                #region Error Description
                case IDS_ERR_MODE_ISP_FAIL:
                    strErr = "Chip is not in ISP mode.";
                    break;
                #endregion

                #region PRoject Error Description

                case IDS_ERR_SECTION_PROJECT_CONTENT_FILE_NOTEXIST:
                    strErr = "Project content file does not exist.";
                    break;
                #endregion
				...
				case IDS_ERR_PROSFL_XML_SCAN_ADC:
					strErr = "Scan register information in XML has error, please check Engineer to correct Extension";
					break;
				case IDS_ERR_PROSFL_XML_REGISTER:
					strErr = "Offset register information in XML has error, please check Engineer to correct Extension";
					break;
				case IDS_ERR_PROSFL_DEM_ACCESS_FAIL:
					strErr = "Access chip through DEM failed, DEM function maybe damage";
					break;
				case IDS_ERR_PROSFL_DEM_WRITE_FAIL:
					strErr = "Write chip through DEM failed, DEM function maybe damage";
					break;
				case IDS_ERR_PROVOLT_VOLT_ADC_DATA:
					strErr = "Voltage ADC scan failed, please check communication is OK first";
					break;
				case IDS_ERR_PROVOLT_VOLT_2nd_OFFSET:
					strErr = "Voltage 2nd Offset read failed, please check communication and EEPROM accessible";
					break;
				case IDS_ERR_PROVOLT_VOLT_OFFSET_RANGE:
					strErr = "Voltage 2nd Offset is out of range, Voltage Calibration will stop";
					break;
				case IDS_ERR_PROCOLT_VOLT_INPUT_EMPTY:
					strErr = "Input value of voltage are all empty.";
					break;
				case IDS_ERR_PROCURR_1POINT_ADC_DATA:
					strErr = "Cannot get 1st current point ADC data, please check communication";
					break;
				case IDS_ERR_PROCURR_2POINT_ADC_DATA:
					strErr = "Cannot get 2nd current point ADC data, please check communication";
					break;
				case IDS_ERR_PROCURR_INPUT_SAME:
					strErr = "Input values are same value, or 2 ADC data are same, Current Calibration will stop.";
					break;
				case IDS_ERR_PROCURR_INPUT_DIFF:
					strErr = "The difference of 2 input values are too small, Current Calibration will stop";
					break;
				case IDS_ERR_PROCURR_INPUT_SIGNED:
					strErr = "The signed (+/-) of input value is different with ADC value, Current Calibration will stop";
					break;
				case IDS_ERR_PROCURR_CURR_ADC_DATA:
					strErr = "Cannot get current ADC data, please check communication";
					break;
				case IDS_ERR_PROCURR_CURR_2nd_OFFSET:
					strErr = "Cannot get current 2nd offset value, please check communication or EEPROM accessible";
					break;
				case IDS_ERR_PROCURR_CURR_OFFSET_RANGE:
					strErr = "New Current 2nd Offset value is out of range, Current Calibration will stop";
					break;
				case IDS_ERR_PROTEMP_TEMP_ADC_DATA:
					strErr = "Temperature ADC scan failed, please check communication is OK first";
					break;
				case IDS_ERR_PROTEMP_TEMP_2nd_OFFSET:
					strErr = "Temperature 2nd Offset read failed, please check communication and EEPROM accessible";
					break;
				case IDS_ERR_PROTEMP_TABLE_PHYTOHEX:
					strErr = "Convert input temperature to hex value failed, maybe input value wrong or table is not correct";
					break;
				case IDS_ERR_PROTEMP_TEMP_OFFSET_RANGE:
					strErr = "Temperature 2nd Offset is out of range, Temperature Calibration will stop";
					break;
				#endregion

                #region Expert SFL error description
                case IDS_ERR_EXPSFL_XML:
                    strErr = "Parsing information of xml has error, file maybe damage, please contact O2Micro";
                    break;
                case IDS_ERR_EXPSFL_DATABINDING:
                    strErr = "Cannot find information of register, file maybe damage, please contact O2Micro";
                    break;
                #endregion
        ...
        public static void UpdateErrorInfoList(ObservableCollection<string> list)
        {
            m_error_info_list.Clear();
            m_error_info_list = list;
        }    

        public static void UpdateDynamicalLibError(ref Dictionary<UInt32,string> dic)
        {
            m_dynamicErrorLib_dic.Clear();
            m_dynamicErrorLib_dic = dic;
        }

        public static void UpdateDynamicalErrorDescription(UInt32 ret, string[] InParams)
        {
            return;
        }
        #endregion
