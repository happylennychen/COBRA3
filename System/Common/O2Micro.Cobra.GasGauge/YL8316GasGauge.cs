...
namespace O2Micro.Cobra.GasGauge
{
	public class YL8316GasGauge : GasGaugeInterface
	{
		...
		private void bmu_init_chip()
		{
			...
			bmu_printk(string.Format("AAAA O2MICRO YL8316 DRIVER VERSION is {0}", VERSION));
			...
			bmu_printk(string.Format("O2MICRO YL8316 test parameter  {0:F2},{1:F2},{2:F2},{3:F2},{4:F2},{5:F2},{6:F2},{7:d},{8:d},",
				myProject.dbPullupR,
				myProject.dbPullupV,
			...
			*/
			...
			bmu_printk(string.Format("O2MICRO YL8316 parameter  {0:F2},{1:F2},{2:F2},{3:F2},{4:F2},{5:d},{6:F2},{7:d},{8:d}",
				myProject.dbPullupR,
				myProject.dbPullupV,
				2.5F,//myProject.fVoltLSB,
				myProject.dbDesignCp,
		...
		private void wait_ocv_flag_fun()
		{
            ...
            bmu_printk("O2micro register 0x09 is ");
