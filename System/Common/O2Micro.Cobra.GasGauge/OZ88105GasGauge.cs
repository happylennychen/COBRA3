...
namespace O2Micro.Cobra.GasGauge
{
	public class OZ88105GasGauge : GasGaugeInterface
	{
		...
		private string CM_PATH = string.Format("o2microapi");
		...
		private void bmu_init_chip()
		{
			...
			bmu_printk(string.Format("AAAA O2MICRO OZ88105 DRIVER VERSION is {0}", VERSION));
			...
			bmu_printk(string.Format("O2MICRO OZ88105 test parameter  {0:F2},{1:F2},{2:F2},{3:F2},{4:F2},{5:F2},{6:F2},{7:F2},{8:F2},{9:F2},{10:d},{11:d},",
			...
			bmu_printk(string.Format("O2MICRO OZ88105 test parameter  {0:F2},{1:F2},{2:F2},{3:F2},{4:F2},{5:F2},{6:F2},{7:F2},{8:F2},{9:F2},{10:F2},{11:F2},",
				(myProject.dbRsense * 1000),
				myProject.dbPullupR,
				myProject.dbPullupV,
				2.5F,//myProject.dbCARLSB,
			...
			{
				bmu_printk("AAAA O2MICRO oz88105 DRIVER Big Error\n");
				printk("AAAA O2MICRO oz88105 can't read OZ88105_OP_OCV_LOW\n");
			...
			*/
			...
			GetCtrlValue(ref i);
			bmu_printk(string.Format("O2micro register 0x09 is 0x{0:X2}", i));
		}
