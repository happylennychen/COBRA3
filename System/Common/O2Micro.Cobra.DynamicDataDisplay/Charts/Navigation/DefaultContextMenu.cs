...
namespace Microsoft.Research.DynamicDataDisplay.Navigation
{
	...
	public class DefaultContextMenu : IPlotterElement
	{
		...
		protected ContextMenu PopulateContextMenu(IInputElement target)
		{
            ...
            MenuItem LegendMenuItem = new MenuItem
            {
                Header = Properties.Resources.ContextMenuLegend,
                ToolTip = Properties.Resources.ContextMenuLegendTooltip,
                Command = ChartCommands.IsShowLegend,
                Icon = new Image { Source = helpIcon },
                CommandTarget = target
            };
            ...
            staticMenuItems.Add(LegendMenuItem);
			//staticMenuItems.Add(quickHelpMenuItem);   //leon bug 15112
