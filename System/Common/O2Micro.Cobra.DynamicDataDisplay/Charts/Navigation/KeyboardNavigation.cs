...
namespace Microsoft.Research.DynamicDataDisplay.Navigation
{
	...
	public class KeyboardNavigation : IPlotterElement
	{
		...
		private void InitCommands()
		{
            ...
            var IsShowLegendCommandBinding = new CommandBinding(
                ChartCommands.IsShowLegend,
                IsShowLegendExecute,
                IsShowLegendCanExecute);
            AddBinding(IsShowLegendCommandBinding);
        ...
        private void IsShowLegendExecute(object target, ExecutedRoutedEventArgs e)
        {
            ChartPlotter plotter = target as ChartPlotter;
            if (plotter == null) return;

            if (plotter.Legend.IsVisible == true)
        ...
        private void IsShowLegendCanExecute(object target, CanExecuteRoutedEventArgs e)
        {
            e.CanExecute = true;
        }
